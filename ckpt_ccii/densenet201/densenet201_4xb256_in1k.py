checkpoint_file = 'https://download.openmmlab.com/mmclassification/v0/densenet/densenet201_4xb256_in1k_20220426-05cae4ef.pth'
model = dict(
...
resume_from = None
workflow = [('train', 1)]
work_dir = 'work_dirs_Clean-CC-CCII/densenet201'
gpu_ids = range(0, 2)
