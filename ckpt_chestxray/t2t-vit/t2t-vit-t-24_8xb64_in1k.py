...
data = dict(
    ...
    train=dict(
        type='ImageNet',
        data_prefix='../data/ChestXray/train/',
        classes='../data/ChestXray/classes.txt',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='RandomResizedCrop',
    ...
    val=dict(
        type='ImageNet',
        data_prefix='../data/ChestXray/',
        ann_file='../data/ChestXray/test.txt',
        classes='../data/ChestXray/classes.txt',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
work_dir = './work_dirs/t2t-vit-t-24_8xb64_in1k'
gpu_ids = range(0, 2)
